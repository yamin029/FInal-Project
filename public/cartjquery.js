...
$.each(cart_items,function(i,val){ 
    ...
    $.each(localStorageproduct,function(j,val){
        ...
        if(cart_items[i].title == localStorageproduct[j].name){
            console.log("yes")
            ...
            cart_item.children("div:first-child").children().children("img").attr("src",localStorageproduct[j].image)
            cart_item.children("div:first-child").children().children("span").text(localStorageproduct[j].name)
